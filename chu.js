...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const bloomPass = new UnrealBloomPass(new THREE.Vector2(box.clientWidth, box.clientHeight), 5, 1.2, 0)
    ...
    window.onresize = () => {
        ...
        // 更新 EffectComposer 和 UnrealBloomPass 的尺寸
        composer.setSize(box.clientWidth, box.clientHeight)
        bloomPass.setSize(box.clientWidth, box.clientHeight)
    }
